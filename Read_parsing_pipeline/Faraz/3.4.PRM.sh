...
# ["mm10"]="/workdir/genomes/Mus_musculus/mm10/ENSEMBL/Mus_musculus.GRCm38.dna.toplevel.fa" \
...
tagDir(){
  ...
  /workdir/tools/homer/bin/makeTagDirectory "$iSUB".tag.dir "$i"
  done
  cd ..
}
...
annotatePeaks(){
    ...
    /workdir/tools/homer/bin/annotatePeaks.pl allSamplesMergedPeakset.saf ${DIR} -gtf ${gtfs[${DIR}]} > allSamplesMergedPeakset_Annotated.saf
    cd ../..
}
